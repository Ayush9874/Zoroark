...
export function ExecutorNode({ data }: any) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative px-6 py-4 rounded-xl border-2 transition-all duration-500 min-w-[240px]",
        status === 'running' ? "bg-orange-500/10 border-orange-500 shadow-[0_0_20px_rgba(249,115,22,0.2)]" : 
    ...
    >
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] font-mono uppercase tracking-widest text-zinc-500">Python Executor</span>
        </div>
      ...
      {status === 'done' && data.result && (
        ...
        >
          <div className="text-[10px] font-mono text-emerald-400/80 uppercase mb-1">Result</div>
