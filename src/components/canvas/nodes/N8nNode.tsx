...
export function N8nNode({ data }: any) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        status === 'running' ? "bg-purple-500/10 border-purple-500 shadow-[0_0_20px_rgba(168,85,247,0.2)]" : 
    ...
    >
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] font-mono uppercase tracking-widest text-zinc-500">n8n Webhook</span>
        </div>
      ...
      {status === 'done' && data.result && (
        ...
        >
          <div className="text-[10px] font-mono text-emerald-400/80 uppercase mb-1">Status</div>
