    ...
    >
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] font-mono uppercase tracking-widest text-zinc-500">Output</span>
        </div>
      ...
      {status === 'done' && data.result && (
        ...
        >
          <div className="text-[10px] font-mono text-emerald-400/80 uppercase mb-1">Final Status</div>
