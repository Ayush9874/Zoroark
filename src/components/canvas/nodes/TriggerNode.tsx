  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        status === 'running' ? "bg-amber-500/10 border-amber-500 shadow-[0_0_20px_rgba(245,158,11,0.2)]" : 
    ...
    >
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] font-mono uppercase tracking-widest text-zinc-500">Trigger</span>
        </div>
      ...
      {status === 'done' && data.result && (
        ...
        >
          <div className="text-[10px] font-mono text-emerald-400/80 uppercase mb-1">Input</div>
          <div className="text-[11px] text-emerald-200/90 leading-tight line-clamp-2">{data.result}</div>
        </motion.div>
      )}
